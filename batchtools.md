...
* a cluster function file [batchtools.conf.R](https://github.com/ChristofSeiler/sherlock/blob/master/batchtools.conf.R) that contains information about the location of slurm_batchtools.tmpl
